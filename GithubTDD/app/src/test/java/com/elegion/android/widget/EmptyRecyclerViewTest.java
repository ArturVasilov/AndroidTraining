package com.elegion.android.widget;
...
public class EmptyRecyclerViewTest {
    ...
    public void testEmptyView() throws Exception {
        TestAdapter adapter = spy(new TestAdapter(new ArrayList<TestValue>()));
    ...
    private List<TestValue> values() {
        ...
        values.add(new TestValue(5));
        values.add(new TestValue(10));
        values.add(new TestValue(15));
        values.add(new TestValue(20));
        return values;
    }
